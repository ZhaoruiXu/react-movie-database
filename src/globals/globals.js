...
export const catStorageName = "mov-db-category";
export const searchQueryStorageName = "mov-db-search";
...
export const endPointGetW500Poster = "https://image.tmdb.org/t/p/w500/";
export const endPointGetOriginalBackDrop =
